...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('person_objects', function (Blueprint $table) {
            ...
            $table->string('persone')->nullable();
            $table->string('eventi')->nullable();
            ...
            $table->string('dimensione_1')->nullable();
            $table->string('tecnica_1')->nullable();
            ...
            $table->string('anno_di_realizzazione_1')->nullable();
            $table->string('titolo_1')->nullable();
